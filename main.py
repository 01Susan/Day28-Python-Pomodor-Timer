...
# TODO 2. Setting the size of window and background color
window.config(padx=100, pady=50, bg=YELLOW)

# Created the canvas which is similar to div in html and css
...
start_button = Button(text="Start", pady=8, padx=10, command=start_timer)
start_button.grid(column=0, row=3)
# Creating the reset button
reset_button = Button(text="Reset", pady=8, padx=10, command=reset_time)
